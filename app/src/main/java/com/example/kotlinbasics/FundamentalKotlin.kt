...
class FundamentalKotlin {
    fun main() {
        //var : bisa diubah isinya
        //val : tidak dapat diubah isinya (immutable variable)
        val bornPlace = "Yogyakarta"
        print("You born in " + bornPlace)
